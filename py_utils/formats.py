...
class Formats:
  ...
  def path_database(self, filename):
    ...
    Notes
    -----
      Retorna uma string com o path completo para o diretório py_databases

    """
    try:
      return os.path.join(os.path.dirname(__file__), "../py_databases/" + filename)
      # return os.path.abspath(
      #     os.path.join(
      #         os.path.dirname(os.getcwd()), "python/py_databases/" + filename
      #     )
      # )
