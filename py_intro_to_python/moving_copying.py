...
# shutil.copy(os.path.join(os.getcwd(), 'py_intro_to_python/arquivo_teste.txt'), os.path.join(os.getcwd()))  # copy file
# shutil.copytree(os.path.join(os.getcwd(), 'py_intro_to_python/teste_folder'), os.path.join(os.getcwd(), 'teste_folder_back'))  # copy folder
# shutil.move(os.path.join(os.getcwd(), 'py_intro_to_python/arquivo_teste.txt'), os.getcwd())  # move file and folder
shutil.move(os.path.join(os.getcwd(), 'py_intro_to_python/arquivo_teste2.txt'), os.path.join(os.getcwd(), 'py_intro_to_python/arquivo_teste.txt'))  # rename
